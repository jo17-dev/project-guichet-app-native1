    ...
    public void valider(){
       System.out.println("Validation de la transaction de depot");
        ...
        if(comptesEntry.getValue().toString().toLowerCase().contains("epargne")){
            App.gestionnaire.depotEpargne(App.loggedUser.getCodeClient(), Integer.parseInt(numroCompteCible) ,Double.parseDouble(montant));
            System.out.println("depot du compte ");
        }else{
