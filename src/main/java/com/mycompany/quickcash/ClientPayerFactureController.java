 ...
 * @author samsl
 */
public class ClientPayerFactureController implements Initializable {
    ...
    public void valider(){
        ...
        App.gestionnaire.paiementFacture(App.loggedUser.getCodeClient(), Integer.parseInt(numroCompteCible), Double.parseDouble(montant));
